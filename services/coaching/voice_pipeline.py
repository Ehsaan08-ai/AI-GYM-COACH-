...
class VoicePipeline:
    ...
    def _find_form_issue(self, exercise, metrics):
        ...
        if exercise == "Squats":
            ...
            if hip_status == "PIKED_UP":
                return "The user's hips are too high - lower them to form a strainght line."
            ...
            if shoulder == "ELBOW DRIFTING":
                return (
                    "The user's elbow is drifting away from their side during the curl."
                )
            ...
            if back_arch == "Excessive Arch":
                return (
                    "The user is arching their lower back excessively during the press."
                )
