...
class ShoulderPressDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        key_landmarks_visible = (
            landmarks[shoulder_idx].visibility > self.MIN_VISIBLITY
            and landmarks[elbow_idx].visibility > self.MIN_VISIBLITY
            and landmarks[wrist_idx].visibility > self.MIN_VISIBLITY
        )
